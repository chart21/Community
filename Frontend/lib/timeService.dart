...
//helps to track the time of the reservation and start clocks
void main() {
...
class TimeElapser extends StatefulWidget {
  @override
  _TimeElapserState createState() => _TimeElapserState();
}

class _TimeElapserState extends State<TimeElapser> {
  @override
